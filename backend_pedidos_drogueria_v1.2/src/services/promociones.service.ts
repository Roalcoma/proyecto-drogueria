    ...
    static async getProveedores(search?: string) {
        ...
        const result = await pool.request()
            ...
            .query(`
                ...
                INNER JOIN ARTICULOSCAMPOSLIBRES ARCL WITH (NOLOCK) ON ARCL.CODPROVEEDORICG = P.CODPROVEEDOR
                INNER JOIN ARTICULOS ART WITH (NOLOCK) ON ART.CODARTICULO = ARCL.CODARTICULO
