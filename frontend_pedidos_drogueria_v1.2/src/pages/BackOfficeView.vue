...
const MODULOS = [
  ...
  { bit: 512, codigo: 'DESCUENTO_LINEA', nombre: 'Descuentos en línea',  icono: 'mdi-percent'       },
  ...
  { bit: 524288, codigo: 'RECHEQUEO',   nombre: 'Rechequeo de Compras',  icono: 'mdi-clipboard-check'    },
];
